...
class Address(object):
    ...
    def _generate(self, publicKey='', privateKey='', seed='', nonce=0):
        ...
        addressHash = crypto.hashChain(crypto.str2bytesLATIN(unhashedAddress))[0:4]
        self.address = base58.b58encode(crypto.str2bytesLATIN(unhashedAddress + addressHash))
    ...
    def dataTransaction(self, data, timestamp=0, baseFee=pywaves.DEFAULT_BASE_FEE, minimalFee=500000):
        if not self.privateKey:
            ...
            for i in range(0, len(data)):
                d = data[i]
                keyBytes = crypto.str2bytesUTF8(d['key'])
                ...
                if d['type'] == 'binary':
                    ...
                    dataBinary += crypto.str2bytesUTF8(d['value'])
